...
import image from "../assets/Cristiano Ronaldo Training.jpeg"; // Importez votre image
...
const Home = () => {
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "100vh", padding: "0 2rem", position: "relative" }}>
      ...
      {/* Image avec cadre stylisé alignée à droite */}
      <div
        style={{
          position: "relative",
      ...
      >
        ...
        <motion.div
          ...
          initial={{ rotate: 0, strokeDasharray: "24 10" }} // Position initiale
          animate={{
