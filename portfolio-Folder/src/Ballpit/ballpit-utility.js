...
const X = {
  count: 200,
  colors: [128, 0, 128], // Couleur violette en RGB
  ambientColor: 0xffffff, // Couleur ambiante en hexadécimal (blanc)
  ambientIntensity: 1, // Intensité de la lumière ambiante
  lightIntensity: 200, // Intensité de la lumière principale
  materialParams: {
    metalness: 0.5,
    roughness: 0.5,
    clearcoat: 1,
  ...
  wallBounce: 0.95, // Rebond sur les murs
  maxVelocity: 0.15, // Vitesse maximale
  maxX: 5, // Limite en X
  maxY: 5, // Limite en Y
  maxZ: 2, // Limite en Z
  controlSphere0: false, // Contrôle de la sphère
  followCursor: true, // Suivi du curseur
};
const U = new m();
